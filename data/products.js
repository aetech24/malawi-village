export const products = [
  ...
  },
  {
    ...
    price: { big: 16, small: 10 },
    size: ["L", "S"],
    image: "../public/asssts/image-1.jpg",
    description:
    ...
    category: "Refreshment",
    ingredient: ["Organic orange jucie"],
  },

  {
    ...
    price: { big: 16, small: 10 },
    size: ["L", "S"],
    image: "../public/asssts/image-3.jpg",
    description:
...

  {
    ...
    category: "Refreshment",
    ingredient: ["Ginger Roots,", "lime", "Pineapple", "Clove", "Agave"],
  },

  {
    ...
    category: "Refreshment",
    ingredient: ["Mango", "pineapple", "ginger", "lime", "lemmon", "agave"],
  },

  // second category detox and immune booster
  {
    id: 6,
    name: "Vitamin C",
    price: { big: 16, small: 10 },
    ...
    ingredient: ["Grapefruit", "lime", "orange", "ginger", "cayenne pepper"],
  },
...

  {
    ...
    image: "../public/asssts/image-3.jpg",
    description:
      "A good source of vitamin A, C, folate, calcium, and fiber. Rich in protective antioxidants, May have anti-cancer properties and anti-inflammatory properties. May lower blood pressure, improve digestive health, May protect the gut and improve exercise performance and support energy levels Drinking beetroot juice could actually help you exercise for up to 16% longer.",
    category: "Detox and Immune booster",
    ingredient: ["Beet Roots", "Apple", "Orange", "Kale", "Ginger lemon"],
  },
...

  {
    ...
    size: ["L", "S"],
    image: "../public/asssts/image-3.jpg",
    description: '-	Fuel your senses with the pleasant aroma and taste of orange and rosemary. From the first sip, the blend is bright and delicate, mimicking the sweet summer flavor of freshly sliced oranges, followed by a pleasant surprise of rosemary',
    category: "Sweet and unsweet tea",
    ingredient: [
      "orange",
      "Rosemery",
